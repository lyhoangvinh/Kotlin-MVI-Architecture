...
object BuildPlugins {
    private const val TOOLS_BUILD = "8.5.0"
    private const val KT_LINT = "9.2.1"
    private const val SAFE_ARGS = "2.7.7"
    ...
    const val DAGGER_HILT_PLUGIN = "com.google.dagger:hilt-android-gradle-plugin:2.51"
    const val KOTLIN_GRADLE_PLUGIN = "org.jetbrains.kotlin:kotlin-gradle-plugin:1.9.23"
...
object Lib {
    ...
    object Di {
        private const val DAGGER_VERSION = "2.51"
    ...
    object Room {
        ...
        val roomCommon = "androidx.room:room-common:$roomVersion"
    }

    object Networking {

        private const val retrofitVersion = "2.9.0"
        private const val retrofitConverterScalarsVersion = "2.3.0"
        private const val okhttpVersion = "4.10.0"
        private const val tinderScarletVersion = "0.1.12"
        ...
        private const val retrofitConverterScalars =
            "com.squareup.retrofit2:converter-scalars:$retrofitConverterScalarsVersion"
        private const val okhttp3Okhttp = "com.squareup.okhttp3:okhttp:$okhttpVersion"
