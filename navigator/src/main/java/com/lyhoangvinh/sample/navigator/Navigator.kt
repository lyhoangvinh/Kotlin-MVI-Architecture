...
abstract class NavigatorHelper : Navigator() {
  ...
  suspend fun handleNavigationCommands(navController: NavController) {
    navigationCommands
      .onSubscription { this@NavigatorHelper.navControllerFlow.value = navController }
      .onCompletion { this@NavigatorHelper.navControllerFlow.value = null }
